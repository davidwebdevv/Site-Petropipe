    ...
    <div className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <Link href="/produtos/tubos" className="block p-6 bg-white rounded-lg shadow hover:shadow-lg">
          ...
          <Link href="/produtos/valvulas" className="block p-6 bg-white rounded-lg shadow hover:shadow-lg">
            <h3 className="text-lg font-semibold">Válvulas</h3>
